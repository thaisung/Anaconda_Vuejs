        ...
        <div class="flex flex-col sm:flex-row sm:gap-5 gap-1 font-bold text-[14px] my-4 " >
            ...
            <div class=" flex flex-col relative items-center gap-1 rounded py-1 px-2 cursor-pointer " v-bind:class="{'bg-white dark:bg-slate-200 text-[16px] text-lime-700': counter.tabnaptien_CRYPTO == 2,}" v-on:click="counter.tabnaptien_CRYPTO=2">
              <div class="flex gap-1">
                <h1>CRYPTO</h1>
                <font-awesome-icon icon="fa-solid fa-caret-down" v-on:click="counter.menu_CRYTOP=!counter.menu_CRYTOP" class=" flex text-[22px] items-center bg-gray-300 dark:hover:bg-slate-400  px-1 rounded shadow-inner" />
              ...
              <div v-show="counter.menu_CRYTOP" class="flex flex-col gap-2 text-[13px] w-full items-center absolute top-[38px] bg-white dark:bg-slate-200 rounded py-2">
