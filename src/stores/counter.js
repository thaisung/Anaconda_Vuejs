...
export const useCounterStore = defineStore('counter', {
  state: () => {
    return { 
             URLServer:'https://todayserver.store',
            //  URLServer:'http://127.0.0.1:8000',
             URLServerF:'http://127.0.0.1',openMoon:1, openDark:'darkk', opentieudedangnhap:1, showdangnhap:false, opendangki:1, openbgdangki:1, 
             ...
             noichuoi:'((thai))',codeOTP:null,ketquasosanhOTP:{data:[]},thongbaoloiOTP:{thongbao:'thong bao u',so:2},resetpassword:'',ketquaresetpassword:{thongbao:'th',so:2,status:'th'},dulieulichsugiaodich:{data:{Data:[{Content:'','Buy_Data':'m\r\n','Payment_Amount':'','Code_Orders':''}]}},
             product_name_buy:'',quantity_buy:'',thongbaoloidangkitaikhoan:{so:1,thongbao:'th'},thongtindoimatkhau:null,tabnaptien_CRYPTO:1,menu_CRYTOP:false,BgCl:'',
