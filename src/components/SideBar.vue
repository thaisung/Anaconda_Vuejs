<template>
    <div v-if="typeof counter.openthongtincanhan.username == 'string'" class="flex  lg:flex-col   text-sky-900 dark:text-sky-400 dark:bg-slate-900 rounded shadow-inner  text-[16px] justify-center lg:justify-start font-medium md:min-w-[220px] ">
        ...
        <router-link to="/personal/accuracy">
            <div class="flex  gap-1 px-2 py-2 border-2 border-sky-900 dark:border-sky-400"  v-bind:class="{'bg-sky-900 text-white dark:bg-sky-400 dark:text-slate-900 ': counter.Route.path==counter.tab_parent.personal_page_accuracy}" v-on:click="counter.openTabpersonal();">
        ...
        <router-link to="/personal/changepassword">
            <div class="flex gap-1 px-2 py-2 border-2 border-sky-900 dark:border-sky-400"  v-bind:class="{'bg-sky-900 text-white dark:bg-sky-400 dark:text-slate-900': counter.Route.path==counter.tab_parent.personal_page_changepassword}" v-on:click="counter.openTabpersonal();">
